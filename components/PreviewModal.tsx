...
const PreviewModal: React.FC<PreviewModalProps> = ({ isOpen, onClose, imageSrc, onGenerate, isLoading, t }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      {/* Modal Content */}
      <div className="relative w-full max-w-4xl bg-slate-900 rounded-2xl shadow-2xl overflow-hidden border border-slate-700 animate-in fade-in zoom-in-95 duration-200">
        ...
        <div className="aspect-video w-full bg-slate-950 flex items-center justify-center relative">
          ...
          <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-slate-900 to-transparent">
             <p className="text-slate-300 text-sm text-center font-medium drop-shadow-md">
               {t.previewSubtitle}
             </p>
          </div>
        </div>
